...
public class AlgorithmTestFixture1 extends AbstractAlgorithmTestFixture {
    ...
    public void verifyFunctionalDependencyResultReceiver() throws CouldNotReceiveResultException {
        ...
        verify(fdResultReceiver).receiveResult(new FunctionalDependency(new ColumnCombination(expC), expB));
        verify(fdResultReceiver).receiveResult(new FunctionalDependency(new ColumnCombination(expB), expD));
        verify(fdResultReceiver).receiveResult(new FunctionalDependency(new ColumnCombination(expC), expA));

        verify(fdResultReceiver).receiveResult(new FunctionalDependency(new ColumnCombination(expC), expD));
        verify(fdResultReceiver).receiveResult(new FunctionalDependency(new ColumnCombination(expD), expB));
        verify(fdResultReceiver).receiveResult(new FunctionalDependency(new ColumnCombination(expA, expB), expC));
        verify(fdResultReceiver).receiveResult(new FunctionalDependency(new ColumnCombination(expA, expD), expC));
